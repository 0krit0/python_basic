...
this_list3 = ["mango", "pineapple", "geape"]
...
this_list7 = ["oeagne", "mango", "kiwi", "pineapple", "banana"]
this_list7.sort()
print(this_list7, len(this_list7))
this_list8 = ["oeagne", "mango", "kiwi", "pineapple", "banana"]
this_list8.reverse()
